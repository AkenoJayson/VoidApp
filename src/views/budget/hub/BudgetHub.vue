...
const moduleInfo = ref({
    ...
    tagline: 'Budget Hub',
    description: 'Welcome to the Budget core. This module aggregates your real-time liquidity, projected expenses, and savings goals into a single operational interface.',
    metrics: []
});
...
const subPages = ref([
    {
        ...
        img: 'https://assets.voidtech.uk/hub/budget/transactions.jpg'
    },
    {
        name: 'Budget Analysis',
        url: '/budget/transactionreports',
        icon: 'ri-pie-chart-2-line',
        img: 'https://assets.voidtech.uk/hub/budget/budget-chart.jpg'
    },
    {
        name: 'Transaction Categories',
        url: '/budget/transactioncategories',
        icon: 'ri-exchange-dollar-line',
        img: 'https://assets.voidtech.uk/hub/budget/transaction-categories.jpg'
    }
]);
