...
const moduleInfo = ref({
    name: 'App Management',
    tagline: 'App Hub',
    description: 'Welcome to the App core. This module aggregates your real-time app usage, projected updates, and performance metrics into a single operational interface.',
    metrics: []
});
...
const subPages = ref([
    {
        ...
        url: '/homeserver/apps',
        icon: 'ri-apps-line',
        img: 'https://assets.voidtech.uk/hub/homeserver/webapps.jpg'
    }
]);
